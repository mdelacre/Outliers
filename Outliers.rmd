...
*Random* outliers are values that just randomly appear out of pure (un)luck. Imagine a perfectly well-balanced coin that yields 100 times heads on 100 throws. Random outliers are per definition very unlikely, but still possible. Considering usual cutoffs to detect outliers (see below), no more than .27% of random outliers should be expected (however, variations around this value will be greater in small datasets than in large datasets).  
